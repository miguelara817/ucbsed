        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    <!-- Page pre-title -->
                    <h2 class="page-title">
                        {{ __('Detalles del cargo ') }}
                    </h2>
                </div>
                <!-- Page title actions -->
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('cargos.index') }}" class="btn btn-primary d-none d-sm-inline-block">
...
<div class="form-group">
<strong>NIVEL AL QUE PERTENECE:</strong>
{{ $cargo->nivele->nivel }}
</div>
<div class="form-group">
<strong>ÁREA CORRESPONDIENTE:</strong>
{{ $cargo->area->area }}
</div>
