...
@section('title')
    Error en la asignación de ponderadores
@endsection
    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">
                    {{ __('ERROR EN LA ASIGNACIÓN DE PONDERADORES') }}
                </h2>
            </div>
            <!-- Page title actions -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Error de asignación</h3>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body" style="background-color: red; color: white; font-weight: bold">
                                    <p>¡LA SUMATORIA DE LOS PONDERADORES ASIGNADOS POR COMPETENCIA DEBE SER 100!</p>
                                </div>
                                <div class="card">
                                    <a href="javascript:history.back()" class="btn btn-primary">Volver para reasignar ponderadores</a>
                                </div>
                            </div>
                        </div>
                    </div>
