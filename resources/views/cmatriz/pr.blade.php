                                                            ...
                                                            @if (($ejecutivos->competencia_id)==($competencia->id))
                                                                <tr>
                                                                    ...
                                                                    <td id="{{$competencia->id}}">
                                                                        ...
                                                                        <input class="form-control" type="number" min="0" max="100" value="0" name="ejecutivo{{$competencia->id}}[]" id="{{$ejecutivos->factor}}">
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                        @endforeach
                                                            ...
                                                            @if (($medios->competencia_id)==($competencia->id))
                                                                <tr>
                                                                    ...
                                                                    <td id="{{$competencia->id}}">
                                                                        ...
                                                                        <input class="form-control" type="number" min="0" max="100" value="0" name="medio{{$competencia->id}}[]" id="{{$medios->factor}}">
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                        @endforeach
                                                            ...
                                                            @if (($profesionals->competencia_id)==($competencia->id))
                                                                <tr>
                                                                    ...
                                                                    <td id="{{$competencia->id}}">
                                                                        ...
                                                                        <input class="form-control" type="number" min="0" max="100" value="0" name="profesional{{$competencia->id}}[]" id="{{$profesionals->factor}}">
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                        @endforeach
                                                            ...
                                                            @if (($tecnicos->competencia_id)==($competencia->id))
                                                                <tr>
                                                                    ...
                                                                    <td id="{{$competencia->id}}">
                                                                        ...
                                                                        <input class="form-control" type="number" min="0" max="100" value="0" name="tecnico{{$competencia->id}}[]" id="{{$tecnicos->factor}}">
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                        @endforeach
                                                            ...
                                                            @if (($administrativos->competencia_id)==($competencia->id))
                                                                <tr>
                                                                    ...
                                                                    <td id="{{$competencia->id}}">
                                                                        ...
                                                                        <input class="form-control" type="number" min="0" max="100" value="0" name="administrativo{{$competencia->id}}[]" id="{{$administrativos->factor}}">
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                        @endforeach
                                                            ...
                                                            @if (($auxiliars->competencia_id)==($competencia->id))
                                                                <tr>
                                                                    ...
                                                                    <td id="{{$competencia->id}}">
                                                                        ...
                                                                        <input class="form-control" type="number" min="0" max="100" value="0" name="auxiliar{{$competencia->id}}[]" id="{{$auxiliars->factor}}">
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                        @endforeach
