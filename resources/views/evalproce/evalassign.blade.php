...
<div id="loader-contenedor">
    <div id="loader-texto">
        <div id="loader"></div>
        <h3>Habilitando evaluaciones...</h3>
    </div>
</div>
@section('content')
    <!-- Page header -->
            ...
            <div class="row row-deck row-cards">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('evalproces.store') }}" id="formAsign" role="form"
                                ...
                                <div class="contenedor">
                                    ...
                                    <div class="selector-area">
                                        <input type="checkbox" id="area-{{$area->id}}" checked>
                            ...
                            <script>
                                ...
                                // const label = contenedor.children[0].children[1];
                                // console.log(contenedor.children[0].children[1]);

                                // label.addEventListener('click', fun1);
                                // function fun1() {
                                ...
                                for (let index = 0; index < contenedor.children.length; index = index + 3) {
                                    ...
                                    function desplegar() {
                                        ...
                                        if (divContenedor.classList.contains('activo')) {
                                            divContenedor.classList.remove('activo');
                                        } else {
                                            divContenedor.classList.add('activo');
                                        }
                                    }
