...
<html lang="en">
<head>
    <title>Procesos de evaluación</title>
    <style>
        body{
...
<body>
    <div class="row marginBottom">
        ...
        <div class="column">
            <h1 class="detalles-titulo">Procesos de evaluación</h1>
        </div>
    </div>
    {{-- <header>
        <h1 class="detalles-titulo">Procesos de evaluación</h1>
        ...
        <div class="nivel">
            ...
            <div class="nivel-tabla">
                ...
                <table>
                    ...
                    <tbody>
                        @forelse ($evalproces as $key => $evalproce)
                            <tr>
                                <td>{{ ++$num_evalproces }}</td>
                                <td>{{ $evalproce->id }}</td>
                                <td class='ponderacion'>{{ $evalproce->form_version_id }}</td>
