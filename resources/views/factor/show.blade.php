        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                        {{ __('Detalles del factor ') }}
                    </h2>
                </div>
                <!-- Page title actions -->
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('factors.index') }}" class="btn btn-primary d-none d-sm-inline-block">
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        {{-- <div class="card-header">
                            <h3 class="card-title">Detalles de factor</h3>
                        </div> --}}
                        <div class="card-body">
...
<div class="form-group">
<strong>COMPETENCIA A LA QUE CORRESPONDE:</strong>
{{ $factor->competencia->competencias }}
</div>
