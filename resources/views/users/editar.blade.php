        ...
        <div class="row row-deck row-cards">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('users.actualizar', $user->id)}}" method="post" autocomplete="off" novalidate>
                            @csrf
                            <div class="card-body">
                                <input hidden type="number" name="user" id="" value="{{$user->id}}">
                                {{-- <h2 class="card-title text-center mb-4">Crear nuevo usuario</h2> --}}
                                <div class="mb-3">
                                    <label class="form-label">Código</label>
                                    <input type="text" name="codigo" value="{{ old('codigo', $user->codigo) }}" class="form-control @error('codigo') is-invalid @enderror" placeholder="Ingresar código">
                                    @error('codigo')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="apellido" value="{{ old('codigo', $user->apellido) }}" class="form-control @error('apellido') is-invalid @enderror" placeholder="Ingresar apellido">
                                    @error('apellido')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" value="{{ old('codigo', $user->name) }}" class="form-control @error('name') is-invalid @enderror" placeholder="Ingresar nombre">
                                    @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="email" value="{{ old('codigo', $user->email) }}" class="form-control @error('email') is-invalid @enderror" placeholder="Ingresar correo electrónico">
                                    @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="cargo" class="form-control" onchange="cargoidSelect(this.value)">
                                        {{-- <option value=""  disabled selected>Seleccionar una opción</option> --}}
                                        <option value="" disabled selected>{{$user->cargo->cargo}}</option>
                                ...
                                {{-- <div class="mb-3">
                                    ...
                                    <select name="cargo" class="form-control" onchange="cargoSelect(this.value)">
                                        ...
                                        <option value="" disabled selected>{{$user->arbolcargo->cargo_dependiente}}</option>
