                        ...
                        <form action="{{ route('users.store') }}" method="post" autocomplete="off">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-flat">
                                        <input type="password" id="password" name="password" class="form-control @error('password') is-invalid @enderror" placeholder="Contraseña"
                                               autocomplete="off" required onchange="comparar()">
                                ...
                                <div class="form-footer">
                                    <button type="submit" class="btn btn-primary w-100" id="crearBtn">Crear nuevo usuario</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
    ...
    function comparar() {
        ...
        let crearBtn = document.querySelector('#crearBtn');
