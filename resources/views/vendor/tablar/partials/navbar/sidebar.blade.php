...
>
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            ...
            @else
                <ul class="navbar-nav pt-lg-3">
                    <a href="{{route('home')}}" style="text-decoration: none; padding-left: 30px; padding-top: 10px; padding-bottom: 10px; border-left: 5px solid #0054a6; color: #182433">Espacio de trabajo</a>
                </ul>
            @endif
